...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url ?>customer" class="brand-link text-sm d-flex align-items-center">
        ...
        <span class="brand-text font-weight-bold ml-2" style="font-size: 1.5rem;"><?php echo $_settings->info('short_name') ?></span>
    </a>
        ...
        <div class="os-content-glue" style="margin: 0px -8px; width: 249p; height: 646px;"></div>
        <div class="os-padding">
            <div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;">
                <div class="os-content" style="padding: 8px 8px; height: 100%; width: 100%;">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
                        ...
                        <div class="info ml-2">
                            <a href="<?php echo base_url ?>customer/?page=user" class="d-block" style="font-weight: bold; font-size: 1.2rem;"><?php echo ucwords($_settings->userdata('firstname').' '.$_settings->userdata('lastname')) ?></a>
                        </div>
                    </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
